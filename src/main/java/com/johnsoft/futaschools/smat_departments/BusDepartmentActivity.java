package com.johnsoft.futaschools.smat_departments;
...
public class BusDepartmentActivity extends AppCompatActivity {private Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_department);
